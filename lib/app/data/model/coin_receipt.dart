...
class CoinReceipt {
  ...
  bool get isCharge => (type == CoinReceiptType.chargeCoin) || (type == CoinReceiptType.dailyReject) || (type == CoinReceiptType.weeklyReject) || (type == CoinReceiptType.consoleReward) || (type == CoinReceiptType.dailyReward);
