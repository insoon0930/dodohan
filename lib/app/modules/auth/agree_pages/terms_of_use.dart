...
22. 회사는 회원이 전항에서 금지한 행위를 하는 경우, 위반 행위의 경중에 따라 서비스의 이용 제한 및 수사 기관에의 고발 조치 등 합당한 조치를 취할 수 있으며, 이로 인하여 발생한 회원의 손해에 대해 회사는 책임을 지지 않습니다.
23. 회원은 회사의 명시적 사전 동의가 없는 한 서비스의 이용권한 및 기타 이용계약상의 지위를 제3자에게 양도, 증여, 대여할 수 없으며 이를 담보로 제공할 수 없습니다.
24. 회원은 관계법, 이 약관의 규정, 이용안내 및 서비스와 관련하여 공지한 주의사항, 회사가 통지하는 사항 등을 준수하여야 하며, 기타 회사의 업무에 방해되는 행위를 하여서는 안 됩니다. 이로 인해 회사에 손실이 발생한 경우 회사는 회원에게 손해배상을 청구 할 수 있습니다.
25. 회원은 회사의 사전 허락 없이 회사가 정한 이용 목적과 방법에 반하여 영업/광고활동 등을 할 수 없고, 회원의 서비스 이용이 회사의 재산권, 영업권 또는 비즈니스 모델을 침해하여서는 안됩니다.
...
5. 사용자가 생성한 컨텐츠에 불쾌감을 주는 내용이나 욕설이 포함된 경우에 회사는 서비스의 이용을 제한하거나 정지 또는 아이디를 삭제(회수)할 수 있다.
